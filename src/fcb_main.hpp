...
namespace fcb
{
    ...
    class CFCBMain: public mavlinksdk::CMavlinkEvents, de::comm::CCallBack_UdpProxy, de::comm::CCommon_Callback
    {
        ...
        public:
            void OnMessageReceived (const mavlink_message_t& mavlink_message, const bool& processed_by_vehicle = true) override;           
            ...
            void OnServoOutputRaw(const mavlink_servo_output_raw_t& servo_output_raw, const bool& changed)  override;
            ...
            void OnParamReceived(const std::string& param_name, const mavlink_param_value_t& param_message, const bool& changed, const bool &load_parameters_1st_iteration) override;
