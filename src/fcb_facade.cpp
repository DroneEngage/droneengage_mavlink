...
void CFCBFacade::sendSyncFireEvent(const std::string&target_party_id, const std::string event_sid, const Json_de& json_event_message , const bool internal_only) const
{
    Json_de message =
    {
        {"d", event_sid},
        {"m", json_event_message}
    };
